...
export const meetingScreen = {
  ...
  wakeGuardDegraded: "자동 절전을 막지 못했습니다. 녹음 중에는 기기가 잠들지 않도록 설정을 확인해 주세요.",
  // `E-14b` — 녹음이 **끝난 뒤** 해제가 실패한 경우. 위 문구를 쓰면 「녹음 중에는」이 거짓이 된다.
  // 녹음을 다시 켜지 않고, 점유가 남아 있을 수 있다는 사실만 드러낸다.
  wakeGuardCleanupFailed: "절전 방지를 정리하지 못했습니다. 앱을 닫으면 정리됩니다.",
