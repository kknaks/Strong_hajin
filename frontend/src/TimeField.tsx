...
import type { SelectOption, SelectTriggerProps, SelectTriggerState } from "./Select";
import { timeFieldLabel } from "./labels";
...
export function TimeField({
  ...
  const text = value || placeholder || timeFieldLabel.placeholder;
      ...
      >
        {(close) => (
          <SelectOptionPanel
            ...
            onPick={onChange}
            options={options}
            searchPlaceholder={timeFieldLabel.searchPlaceholder}
...
export function TimeRangeField({
  ...
  const message = error ?? (invalid ? timeFieldLabel.rangeInvalid : null);
