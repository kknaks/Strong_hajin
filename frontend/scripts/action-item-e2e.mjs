...
try {
  ...
  // The same question is now Mina's to answer, marked 조정 필요.
  ...
  // The reason that sent it back is on the first screen.
  await minaDrawer.getByText(adjustReason).first().waitFor({ timeout: 10_000 });
